...
var getStartXY = function getStartXY(_ref4) {
  ...
  return {
    ...
    startY: svg.current.getBoundingClientRect().top + document.documentElement.scrollTop + size / 2
  };
  return {
...
var useUpdate = (function (_ref3) {
  var min = _ref3.min,
      ...
      ref = _ref3.ref;
  var svg = React.useRef(); // const container = useRef();
  ...
  var _useReducer = React.useReducer(reducer(onChange), {
    ...
    percentage: initialValue ? initialValue / (max - min) : 0,
...
var Knob = function Knob(_ref2) {
  ...
  var _useState = React.useState({
    ...
    y: 0
      ...
      pageXY = _useState2[0],
      setPageXY = _useState2[1];

  var ref = React.useRef(new XY());
